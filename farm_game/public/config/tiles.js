...
const TILE_DEFINITIONS = [
    ...
    /*103*/ { name: 'Sarah', png: 163, inv: [{num: 36, amount: 5}, {num: 45, amount: 3}], hand: 0, facing: 2, under_tile_num: 1, instructions: [], moving_timer: 100, class: 'Shop', quest_giver: true },
    ...
    /*106*/ { name: 'Thomas', png: 164, inv: [{num: 35, amount: 20}], hand: 0, facing: 2, under_tile_num: 1, instructions: [], moving_timer: 100, class: 'Shop', quest_giver: true },
