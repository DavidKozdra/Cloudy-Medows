...
const ITEM_DEFINITIONS = [
    ...
    /*5*/  { name: 'Sweet Potatoes', png: 60, price: 5, hunger: 1, hunger_timer: 3000, seed_num: 6, seed_min: 2, seed_max: 3, class: 'Eat' },
    /*6*/  { name: 'Sweet Potato Seed', png: 61, plant_num: 22, class: 'Seed' },
    /*7*/  { name: 'Strawberries', png: 62, price: 4, hunger: 1, hunger_timer: 1700, seed_num: 8, seed_min: 2, seed_max: 3, class: 'Eat' },
    ...
    /*15*/ { name: 'Tomato', png: 70, price: 5, hunger: 1, hunger_timer: 1800, seed_num: 14, seed_min: 2, seed_max: 3, class: 'Eat'},
    ...
    /*24*/ { name: 'Hemp Seed', png: 79, price: 5, plant_num: 45, class: 'Seed'},
