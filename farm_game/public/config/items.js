...
const ITEM_DEFINITIONS = [
    ...
    /*2*/  { name: 'Corn', png: 57, price: 4, hunger: 2, hunger_timer: 2000, seed_num: 3, seed_min: 1, seed_max: 2, class: 'Eat' },
    /*3*/  { name: 'Corn Seed', png: 58, plant_num: 21, class: 'Seed' },
    /*4*/  { name: 'Junk', png: 59, price: 0, class: 'Item' },
    /*5*/  { name: 'Sweet Potatoes', png: 60, price: 3, hunger: 1, hunger_timer: 3000, seed_num: 6, seed_min: 2, seed_max: 3, class: 'Eat' },
    /*6*/  { name: 'Sweet Potato Seed', png: 61, plant_num: 22, class: 'Seed' },
    /*7*/  { name: 'Strawberries', png: 62, price: 2, hunger: 1, hunger_timer: 1700, seed_num: 8, seed_min: 2, seed_max: 3, class: 'Eat' },
    ...
    /*15*/ { name: 'Tomato', png: 70, price: 3, hunger: 1, hunger_timer: 1800, seed_num: 14, seed_min: 2, seed_max: 3, class: 'Eat'},
    /*16*/ { name: 'Watermelon Seed', png: 71, plant_num: 41, class: 'Seed'},
    /*17*/ { name: 'Watermelon', png: 72, price: 8, hunger: 2, hunger_timer: 2000, seed_num: 16, seed_min: 3, seed_max: 4, class: 'Eat'},
    ...
    /*39*/ { name: 'Carrot', png: 136, price: 4, hunger: 1, hunger_timer: 2000, seed_num: 40, seed_min: 1, seed_max: 2, class: 'Eat' },
    /*40*/ { name: 'Carrot Seed', png: 137, plant_num: 92, class: 'Seed'},
    /*41*/ { name: 'Pumpkin', png: 144, price: 3, hunger: 3, hunger_timer: 2000, seed_num: 42, seed_min: 5, seed_max: 6, class: 'Eat'},
